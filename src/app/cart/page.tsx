  ...
  return (
    <PageShell>
      ...
      <div className="flex items-end justify-between mb-8">
        ...
        {items.length > 0 && (
          <button
            ...
            className="text-[10px] uppercase tracking-widest text-[#F4F4ED]/30 hover:text-[#F42D23] transition-colors"
            style={{ fontFamily: "satoshi" }}
          >
            Remove all
          </button>
      ...
      {items.length === 0 ? (
        /* ── Empty ── */
        <EmptyState
          icon={<ShoppingBag size={36} className="text-[#F4F4ED]/20" />}
            ...
            <div className="sticky top-28 flex flex-col gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-full bg-[#F4F4ED]/15 group-hover:bg-[#191B1C]/10 flex items-center justify-center transition-colors">
                    <ShoppingBag size={13} />
                  </div>
              ...
              {/* Trust badge */}
              <div className="flex items-center justify-center gap-2 text-[#F4F4ED]/25">
                <ShieldCheck size={12} />
...
function PageShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#191B1C]">
      <Navbar />
  ...
  return (
    <div
      className={`
        ...
        rounded-2xl bg-white/[0.04] border border-white/[0.07]
    ...
    >
      {/* Image */}
      <div className="w-20 h-24 sm:w-24 sm:h-28 rounded-xl overflow-hidden bg-white/5 shrink-0">
        <img
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-3">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <h3
              className="text-[#F4F4ED] text-sm uppercase tracking-tight leading-tight line-clamp-2"
              style={{ fontFamily: "futuraCB" }}
            >
              {item.productName}
            </h3>
            <div className="flex items-center gap-2 mt-1">
              <span
                className="text-[10px] uppercase tracking-wider text-[#F4F4ED]/40"
                style={{ fontFamily: "satoshi" }}
              >
                {item.size}
              </span>
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-[#F4F4ED]/25 hover:text-[#F42D23] hover:bg-[#F42D23]/10 transition-all shrink-0"
          >
            <X size={14} />
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Package size={11} className="text-[#F4F4ED]/30" />
          <span
            className="text-[10px] text-[#F4F4ED]/30 uppercase tracking-wider"
            style={{ fontFamily: "satoshi" }}
          >
            Express · 3–5 days
          </span>
        ...
        <div className="flex items-center justify-between">
          <p
            className="text-[#F4F4ED] text-base"
            style={{ fontFamily: "futuraCB" }}
          >
          ...
          <div className="flex items-center gap-1 bg-white/5 border border-white/10 rounded-full p-1">
            ...
            >
              <Minus size={11} className="text-[#F4F4ED]" />
            </button>
            <span
              className="w-6 text-center text-sm text-[#F4F4ED]"
              style={{ fontFamily: "futuraCB" }}
            >
              {item.quantity}
            </span>
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-white/10 disabled:opacity-30 transition-colors"
            >
              <Plus size={11} className="text-[#F4F4ED]" />
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="rounded-2xl bg-white/[0.04] border border-white/[0.07] overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-white/[0.07]">
        <p
          className="text-[10px] uppercase tracking-[0.2em] text-[#F4F4ED]/40"
          style={{ fontFamily: "satoshi" }}
        >
          Order Summary
        </p>
      ...
      <div className="px-6 py-5 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3 pb-4 border-b border-white/[0.07]">
          {items.map((item) => (
            <div key={item._id} className="flex items-center justify-between gap-3">
              <span
                className="text-xs text-[#F4F4ED]/50 truncate"
                style={{ fontFamily: "satoshi" }}
              >
                {item.productName}
                <span className="text-[#F4F4ED]/25"> ×{item.quantity}</span>
              </span>
              <span
                className="text-xs text-[#F4F4ED]/70 shrink-0"
                style={{ fontFamily: "satoshi" }}
              >
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-[#F4F4ED]/50" style={{ fontFamily: "satoshi" }}>
            Subtotal
          </span>
          <span className="text-sm text-[#F4F4ED]/70" style={{ fontFamily: "satoshi" }}>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-[#F4F4ED]/30" style={{ fontFamily: "satoshi" }}>
            —
          </span>
        </div>
      </div>
      ...
      {/* Total */}
      <div className="px-6 py-5 bg-white/[0.03] border-t border-white/[0.07] flex items-center justify-between">
        <p
          className="text-[10px] uppercase tracking-[0.2em] text-[#F4F4ED]/40"
          style={{ fontFamily: "satoshi" }}
        >
        ...
        <p
          className="text-2xl text-[#F4F4ED]"
          style={{ fontFamily: "futuraCB" }}
        >
...
function EmptyState({ icon, title, sub, action }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-32 text-center gap-5">
      ...
      <div>
        <h2
          className="text-[#F4F4ED] text-2xl uppercase leading-none mb-2"
          style={{ fontFamily: "futuraCB" }}
        >
          {title}
        </h2>
        <p className="text-[#F4F4ED]/40 text-sm" style={{ fontFamily: "satoshi" }}>
          {sub}
        </p>
      </div>
      {action}
...
function ConfirmModal({ title, body, confirmLabel, loading, danger = false, onConfirm, onCancel }: ConfirmModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 pb-6 sm:pb-0">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-sm rounded-3xl bg-[#101213] border border-white/10 p-8 flex flex-col items-center gap-5 shadow-2xl">
        {/* Icon */}
        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${danger ? "bg-[#F42D23]/10" : "bg-white/5"}`}>
          <Trash2 size={22} className={danger ? "text-[#F42D23]" : "text-[#F4F4ED]/40"} />
        </div>

        {/* Text */}
        <div className="text-center">
          <h3
            className="text-[#F4F4ED] text-xl uppercase leading-none mb-2"
            style={{ fontFamily: "futuraCB" }}
          >
            {title}
          </h3>
          <p
            className="text-[#F4F4ED]/40 text-xs leading-relaxed"
            style={{ fontFamily: "satoshi" }}
          >
            {body}
          </p>
        ...
        <div className="flex flex-col gap-2 w-full">
          <button
            ...
            className={`
              ...
              ${danger
                ? "bg-[#F42D23] text-[#F4F4ED] hover:bg-red-700"
          ...
          <button
            onClick={onCancel}
            className="w-full h-11 rounded-xl text-sm text-[#F4F4ED]/40 hover:text-[#F4F4ED] transition-colors"
            style={{ fontFamily: "satoshi" }}
          >
            Cancel
          </button>
...
const primaryBtn =
  "flex items-center gap-2 h-11 px-6 rounded-full bg-[#F42D23] text-[#F4F4ED] text-sm uppercase tracking-[0.1em] hover:bg-[#F4F4ED] hover:text-[#191B1C] transition-colors duration-300";
